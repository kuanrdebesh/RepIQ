...
Note: `basic_gym` is NOT a superset of `home_setup` — they diverge. A home gym has kettlebell but no cables or machines; a basic commercial gym has cables and machines but no kettlebell, smith, or landmine.
